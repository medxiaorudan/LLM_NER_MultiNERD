...
from Data_Preprocessing import data_preprocessing_A
from utils import tokenize_and_align_labels, compute_metrics
from trainer import CustomTrainerA
...
def main_A(args, train_args):
    ...
    ds, id2label, label2id = data_preprocessing_A(original_dataset)
